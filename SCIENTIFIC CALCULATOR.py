...
txtDisplay = Entry(calc, font=('Helvetica',20,'bold'),bg='light blue',fg='black', bd=30,
...
for j in range(2,5):
    for k in range(3):
        btn.append(Button(calc, width=6, height=2, bg='sky blue',fg='black', font=('Helvetica',20,'bold'),
...
btnZero = Button(calc, text="0",width=6, height=2,bg='sky blue',fg='black', font=('Helvetica',20,'bold'),
...
btnlog10 = Button(calc, text="log10",width=6, height=2,bg='black',fg='white', font=('Helvetica',20,'bold')
                  ,bd=4,command=added_value.log10).grid(row=3, column= 5, pady = 1)

btngamma = Button(calc, text="gamma",width=6, height=2,bg='black',fg='white', font=('Helvetica',20,'bold')
                  ,bd=4,command=added_value.lgamma).grid(row=3, column= 6, pady = 1)

#******************************************************************************************************#
lblDisplay1 = Label(calc, text = '''Debanko Sinha''',font=('Ariel',20,'bold'),bg='sky blue',
                   fg='Black',bd=25,width=20,justify=LEFT)
lblDisplay1.grid(row=4, column= 4,columnspan=4)

lblDisplay1 = Label(calc, text = 'K.V.Ballygunge',font=('Ariel',20,'bold'),bg='sky blue',
                   fg='Black',bd=25,width=20,justify=LEFT)
lblDisplay1.grid(row=5, column= 4,columnspan=4)


lblDisplay = Label(calc, text = "SCIENTIFIC CALCULATOR",font=('Ariel',26,'bold'),bg='sky blue',
                   fg='Black',bd=25,width=20,justify=CENTER)
